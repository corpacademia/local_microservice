...
`,
    ...
    UPDATE_USER_COUNT:`UPDATE batches SET user_count = user_count + $1 WHERE id=$2 `,
...
`,
   ...
   UPDATE_ALL_USERLABS: `
    ...
    DELETE FROM singlevmproxmoxuserassignment WHERE labid = $1 AND user_id = $2 RETURNING *;
    `,
