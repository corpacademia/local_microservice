module.exports = {
  ...
  UPDATE_ACTIVE_KEY:`UPDATE license_keys set plan_tier=$1,plan_name=$2,billing_cycle=$3,issued_at=NOW(),expires_at=NOW()+($4 * INTERVAL '1 day'),features=$5,plan_id=$6,license_key=$7,activated=false WHERE org_id=$8 AND status='active' RETURNING *`,
